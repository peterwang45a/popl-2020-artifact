...
--------
Virtual Machine (Removed in order to comply with Matlab’s license) <br>
...
(1). The cfg tool in folder “CFG” parses one program and outputs related data about it (i.e., assignment statements, probabilities).

(2). “chain.m” in folder “Synthesis” processes the data generated by the cfg tool.

(3). “Syntheis.m” in folder “Synthesis” synthesizes the RSM-map.
